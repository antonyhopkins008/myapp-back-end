...
class AuthoredEntitySubscriberTest extends TestCase {
     ...
     * @param string $shouldCallSetAuthor
     * @param string $method
     */
    public function testAuthorCall(string $className, string $shouldCallSetAuthor, string $method)
    {
     ...
     */
    protected function getTokenStorageMock(bool $hasToken = true): MockObject
    {
        $tokenMock = $this
        ...
        //for classes/interfaces we cannot instantiate
    ...
    public function provider(): array
    {
        return [
            ...
            ['NotExistingClass', false, 'POST'],
            [Comment::class, false, 'POST'],
        ];
    }
}
